...
**接口地址**:`/v2/enduser/enduserapi/appleAuthLogin`
...
| ------------- | ------------------------------------------------------------ | -------- | -------- | -------------- | ------ |
| identityToken | Apple 授权成功后获取的 identityToken                         | query    | true     | string         |        |
| signature     | 签名<br/>签名生成规则：SHA256(identityToken+userDomainSecret) | query    | true     | string         |        |
...
| 5104   | 用户域已停用                |                                      |
| 5566   | 公钥为空                    |                                      |
| 5567   | identityToken格式不正确     |                                      |
| 5568   | 请输入identityToken         |                                      |
| 6084   | MCC不属于当前数据中心       |                                      |
| 6085   | 查询MCC的数据中心失败       |                                      |
